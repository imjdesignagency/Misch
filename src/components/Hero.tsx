...
import { Bookmark, ArrowRight, Sparkles, ArrowDown } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-24 -right-24 w-[650px] h-[650px] bg-gradient-to-br from-[#194A37]/20 via-[#648C82]/15 to-transparent rounded-full blur-3xl pointer-events-none"
      />
      <motion.div
        animate={{
          x: [0, -60, 50, 0],
        ...
        className="absolute top-1/3 -left-32 w-[580px] h-[580px] bg-gradient-to-tr from-[#B81617]/15 via-[#FF8585]/12 to-transparent rounded-full blur-3xl pointer-events-none"
      />
      <motion.div
        animate={{
          x: [0, 50, -50, 0],
        ...
        className="absolute -bottom-24 left-1/3 w-[520px] h-[520px] bg-gradient-to-t from-[#648C82]/15 via-[#194A37]/10 to-transparent rounded-full blur-3xl pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Left Column: Dedicated Literary Brand Storytelling Box with Entry Motion & Flowing Animated Gradient */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: [0.21, 0.47, 0.32, 0.98] }}
            className="lg:col-span-7 flex flex-col justify-between text-left relative rounded-3xl p-7 sm:p-10 lg:p-12 animate-hero-gradient text-white shadow-2xl border border-[#2D6650]/40 overflow-hidden group"
          >
            ...
            <div className="relative z-10 space-y-6">
              {/* Brand Feel Eyebrow in Red Serif Italic */}
              <Reveal direction="down" delay={0.1}>
                <div className="flex flex-wrap items-center gap-3">
                  <span className="font-serif italic text-lg sm:text-xl text-[#FF8585] tracking-wide">
                    {hero.eyebrowLabel || 'brand feel:'}
                  </span>
                  <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md text-[#FAF8F5] border border-white/20 px-3.5 py-1 rounded-full text-xs font-sans font-medium">
              ...
              <Reveal direction="up" delay={0.55}>
                <motion.div
                  ...
                  className="w-full bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-2xl border-l-4 border-[#FF7A7A] border-y border-r border-white/15 shadow-inner space-y-2"
                >
            ...
            {/* Action Buttons with Interactive Pulsing */}
            <Reveal direction="up" delay={0.85}>
              <div className="relative z-10 pt-6 mt-6 border-t border-white/15 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={onOpenPreOrder}
                  className="inline-flex items-center justify-center gap-2.5 px-8 py-4 text-xs uppercase font-sans tracking-widest font-bold text-white bg-[#B81617] hover:bg-[#9B1213] rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer border border-[#FF7A7A]/30"
                >
                ...
                >
                  <ArrowDown className="w-4 h-4 text-[#FF7A7A]" />
          ...
          <motion.div
            ...
            className="lg:col-span-5 flex flex-col items-center justify-center relative p-6 sm:p-10 rounded-3xl bg-white/80 backdrop-blur-xs border border-[#E8E2D8] shadow-sm"
          >
            ...
            >
              ...
              {/* Interactive Cue & Core Message */}
              <div className="mt-8 flex flex-col items-center gap-2 text-center">
                <motion.div
                  whileHover={{ scale: 1.03 }}
                  className="flex items-center gap-2 text-xs text-[#194A37] font-sans font-semibold bg-[#FAF8F5] px-4 py-2 rounded-full border border-[#E8E2D8] shadow-2xs"
                >
                  <Sparkles className="w-3.5 h-3.5 text-[#B81617] animate-spin" style={{ animationDuration: '6s' }} />
                  <span>Interactive 3D Cover • Drag or hover to inspect</span>
                </motion.div>
                <p className="font-serif italic text-sm text-[#84937D] mt-1">
                  “{hero.quote}”
                </p>
              </div>
            </motion.div>
